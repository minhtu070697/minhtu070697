...
func _ready():
	...
	var height = height_modifier_percent * 100 + Utils.random_int(230, 285) + rand_range(-height_random_percent * 30, height_random_percent * 30)
...
func _process(_delta):
	if linear_velocity.y > -100:
		var effect = load("res://efx/fireworks/fireworks/" + effect_name.capitalize() + ".tscn").instance()
