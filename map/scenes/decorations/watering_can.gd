...
func _init():
	sprite_names = {
		"watering_can": Vector2(1, 1),
		"watering_can_1": Vector2(1, 1),
		"watering_can_2": Vector2(1, 1)
	}
	sprite_build_positions = {
		"watering_can": Vector2(0, -5),
		"watering_can_1": Vector2(0, -5),
		"watering_can_2": Vector2(0, -5)
	}
